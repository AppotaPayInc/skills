<!-- source: https://docs.appotapay.com/subscription/cancel-cycle -->
...
| 3009 | Không thể hủy cycle. Chỉ hủy cycle ở trạng thái SCHEDULED hoặc RETRYING |

### Code Examples

```bash
curl --location 'https://gateway.dev.appotapay.com/api/v1/subs/plans/01HRVGAJSP7SX83X7AQ9QQYMBE/cycles/01HRVK1SZ5DTDQNRSBYCE14D81/cancel' \
