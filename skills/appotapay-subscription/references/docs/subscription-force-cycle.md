<!-- source: https://docs.appotapay.com/subscription/force-cycle -->
...
| 3010 | Không thể force cycle. Chỉ force cycle ở trạng thái SCHEDULED hoặc RETRYING |
| 3011 | Force cycle quá giới hạn cho phép |
| 3049 | Force cycle đang chờ xử lý, vui lòng thực hiện lại action sau |

### Code Examples

```bash
curl --location 'https://gateway.dev.appotapay.com/api/v1/subs/plans/01HRVGAJSP7SX83X7AQ9QQYMBE/cycles/01HRVK1SZ5DTDQNRSBYCE14D81/force-attempt' \
