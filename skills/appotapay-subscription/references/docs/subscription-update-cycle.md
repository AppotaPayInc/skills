<!-- source: https://docs.appotapay.com/subscription/update-cycle -->
...
| Tham số | Yêu cầu | Kiểu dữ liệu | Mô tả | Lưu ý |
| --- | --- | --- | --- | --- |
| scheduledAt | Optional | String | Thời gian dự kiến thanh toán (định dạng chuẩn ISO-8601) |  |
| currency | Optional | Integer | Đơn vị tiền tệ |  |
| amount | Optional | Integer | Số tiền thanh toán |  |

### Example Request

```json
{
    "scheduledAt": "2024-01-31T10:21:05+07:00",
    "currency": "VND",
    "amount": 405100
}
```
...
Dữ liệu trả về thành công sẽ chứa một Cycle object
...
| 3008 | Cycle không tồn tại |
| 3017 | Thời gian dự kiến thanh toán không hợp lệ |
| 3047 | Không thể cập nhật cycle. Chỉ cập nhật cycle ở trạng thái SCHEDULED |

### Code Examples

```bash
curl --location 'https://gateway.dev.appotapay.com/api/v1/subs/plans/01HRVGAJSP7SX83X7AQ9QQYMBE/cycles/01HRVK1SZ5DTDQNRSBYCE14D81' \
